...
describe("owner action dates", () => {
  it("normalizes optional dates", () => {
    expect(optionalDate("2026-08-18T09:00:00-04:00", "Due date")).toBe(
  ...
  it("only accepts future snooze dates", () => {
    ...
    expect(
      futureOptionalDate("2026-08-19T12:00:00.000Z", "Snooze date", now),
    ).toBe("2026-08-19T12:00:00.000Z");
    expect(() =>
      futureOptionalDate("2026-08-17T12:00:00.000Z", "Snooze date", now),
    ).toThrow("Snooze date must be in the future.");
