...
import { localDateTimeToUtc, nextLocalDateTimeMinute, utcToLocalDateTime } from "./date-time";
...
describe("owner action date-time conversion", () => {
  ...
  it("rounds the input minimum up so every offered minute is in the future", () => {
    expect(nextLocalDateTimeMinute(new Date("2026-08-18T11:00:01.000Z")))
      .toBe(utcToLocalDateTime("2026-08-18T11:01:00.000Z"));
    expect(nextLocalDateTimeMinute(new Date("2026-08-18T11:00:00.000Z")))
      .toBe(utcToLocalDateTime("2026-08-18T11:00:00.000Z"));
  });
});
